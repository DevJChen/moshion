  ...
  return (
    ...
    >
      {!!id && (
        ...
        hover:bg-neutral-300 dark:hover:bg-neutral-600 mr-1"
        role="button"
      ...
      {isSearch && (
        <kbd className="ml-auto pointer-events-none inlie-flex h-5 select-none items-center \
        gap-1 rounded border bg-muted px-1 5 font-mono text-[10px] font-medium 
        text-muted-foregournd opacity-100">
      ...
      {!!id &&(
        <div className="ml-auto flex items-center gap-x-2">
          ...
          <div className="opacity-0 group-hover:opacity-100 h-full ml-auto roudned-sm
           hover:bg-neutral-300 dark:hover:bg-neutral-600"
           role="button"
           onClick={onCreate}
           >
            <Plus className="h-4 w-4 text-muted-foregournd"/>
          </div>
        </div>  
      )}
    </div>
